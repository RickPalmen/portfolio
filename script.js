...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (canHover) {
    ...
    const growTargets = 'a, button, [data-tilt], .case-card, .album-card, .case-previews-grid img, .album-photos img, .traits span, .poster-tile';
  ...
  const sectionIds = ['top', 'about', 'work', 'skills', 'gallery', 'contact'];
  ...
  /* ---------- POSTER SERIES: click to open lightbox ---------- */
  document.querySelectorAll('.poster-tile[data-lightbox]').forEach(tile => {
